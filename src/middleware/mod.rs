...
#[cfg(test)]
mod test {
    use crate::middleware::{traverse, Middleware, NextFunction, Request, Response};
    use crate::middlewares::{Cache, Check, Rewrite};
    ...
    fn caching() {
        ...
        impl Middleware for CheckMock {
            fn handle(&mut self, _: Request, _: NextFunction) -> Response {
                Response { code: 200 }
            }
        }
